...
<div id="content">
<section id="postList" class="jr-site-blog-list all-article-wrap post-<?php echo elemento_blog_layout()?>-view pd-t-100 pd-b-100">
			...
			<?php 
			 if ( have_posts() ) :
				  ...
				  while ( have_posts() ) : the_post();
						 ...
						 */
					get_template_part( 'template-parts/content-'.elemento_blog_layout(), get_post_format() );
