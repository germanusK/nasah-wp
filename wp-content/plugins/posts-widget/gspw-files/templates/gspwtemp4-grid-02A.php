          ...
          <header>
            <?php if (current_theme_supports('post-thumbnails') && $instance['show_thumbnail'] && has_post_thumbnail()) : ?>
                <div class="entry-image meta-img">
                  <a href="<?php the_permalink(); ?>" rel="bookmark"><?php the_post_thumbnail($instance['thumb_size']); ?></a>
                </div>
            <?php endif; ?>
            <div class="meta-data">
            ...
            <?php if ($instance['show_date'] || $instance['show_author'] || $instance['show_comments']) : ?>
                <div class="entry-meta">
                    ...
                    <?php if ($instance['show_comments']) : ?>
                      <span class="dashicons dashicons-admin-comments"></span><a class="comments" href="<?php comments_link(); ?>">
                        <?php comments_number(__('No comments', 'gspw'), __('One comment', 'gspw'), __('% comments', 'gspw')); ?>
                      </a>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
